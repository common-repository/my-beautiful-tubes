...
function displays_video($content) {
   ...
   if (is_single() || is_page() ) {
       ...
       $vidurl = preg_match("/https:\/\/youtu.be\/[-\.\w]+/", $youtube_share_link, $v_match);
       $vid_img_url = preg_match("/https:\/\/youtu.be\/[-\.\w]+/", $video_img_link, $v_img_match);

       if($vidurl === 1) {

         $vidtu = $v_match[0];
         $vidtube = $vidtu;
         $vidtube = str_replace("https://youtu.be/","", $vidtube);

         $display_video = "<div class='beauty-tube-wrap'><div class='beauty-video-wrap'>"."<iframe width=\"473\" height=\"266\" src=\"https://www.youtube.com/embed/$vidtube\" frameborder=\"0\" allowfullscreen></iframe></div>";
         ...
         return $content.$display_video.$fbcomment;
           ...
           foreach($imgposts as $impost) {
              ...
              $img_linkage = preg_match("/https:\/\/youtu.be\/[-\.\w]+/", $video_imag, $imgg_match);
              if($imgg_match[0] == '') {
                continue;
              }
              $imgl = $imgg_match[0];
              $imgl = str_replace("https://youtu.be/","", $imgl);
           ...
           $vid_tube = $vidtub;
           $vid_tube = str_replace("https://youtu.be/","", $vid_tube);
           $display_img_video = "<div class='beauty-tube-wrapper'><div class='beauty-video-wrap'>"."<iframe id='beauty-tubes-video' width=\"473\" height=\"266\" src=\"https://www.youtube.com/embed/$vid_tube\" frameborder=\"0\" allowfullscreen></iframe></div>" .$imagelinks. "</div>";
